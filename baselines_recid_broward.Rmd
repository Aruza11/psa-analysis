...
riskscore_aucs = data.frame(
  ...
  "AUC" = c(
    auc(scores_outcomes_psa$recid, scores_outcomes_psa$arnold_nca_raw),
    auc(scores_outcomes_psa$recid, scores_outcomes_psa$arnold_nca),
    auc(scores_outcomes_test$recid, scores_outcomes_test$`Risk of Recidivism_raw_score`),
    auc(scores_outcomes_test$recid, scores_outcomes_test$`Risk of Recidivism_decile_score`)),
...
#Plotting ROC curves 
for(i in c(1,2,3,4)){
  roc =  roc(riskscore_roc_inputs[[i]][[1]], riskscore_roc_inputs[[i]][[2]], 
             percent = F, boot.n = 1000,
