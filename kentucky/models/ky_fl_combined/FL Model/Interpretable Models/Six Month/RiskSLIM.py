...
def risk_cv(KY_x, KY_y, FL_x, FL_y, y_label, max_coef, max_coef_number, max_runtime, c, seed):
    ...
    ## change data format
    FL_x = FL_x[:,1:]## remove the first column, which is "intercept"
    ...
    ## AUC
    FL_auc.append(roc_auc_score(FL_y, FL_prob))
    KY_auc.append(roc_auc_score(KY_y, KY_prob))
        
    return { 'KY_auc': KY_auc}
