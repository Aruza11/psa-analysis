...
scores_outcomes = compas_psa_wide %>%
                  ...
                  filter(person_id %in% test$person_id)
...
```{r}
scores_outcomes2 = scores_outcomes %>% filter(!is.na(arnold_nca_raw))
auc(scores_outcomes2$recid, scores_outcomes2$arnold_nca_raw)
