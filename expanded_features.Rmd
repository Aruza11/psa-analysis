...
options(tibble.print_max = 150, tibble.print_min = 100)
...
crimes <- c("Overall", "Drug", "Property", "Stalking", "Domestic Violence", "Trespass", "Traffic", "Voyeurism", "Fraud", "Stealing", "DUI")
amt <- c(overall_amt, drug_amt, property_amt, stalking_amt, dom_amt, trespass_amt, traffic_amt, voy_amt, fraud_amt, steal_amt, dui_amt)
vamt <- c(voverall_amt, vdrug_amt, vproperty_amt, vstalking_amt, vdom_amt, vtrespass_amt, vtraffic_amt, vvoy_amt, vfraud_amt, vsteal_amt, vdui_amt)
out_graph = data.frame(Crime = crimes, Frequency = amt, Frequency_Violent = vamt)

out_graph
#ggplot(data = out_graph, mapping = aes(x = Crime)) +
#  geom_bar() + labs(title = "Crimed Recidivised", x = "Crime", y = "Frequency") 
