...
labels = read_csv("~/Duke/Cynthia Research/KY-analysis-mytrials/broward/data/labels_minor_offenses.csv") %>% 
...
```{r}
write.csv(train, file = paste0("train_recid_use_minor_offense", ".csv"), row.names = F)
write.csv(test, file = paste0("test_recid_use_minor_offense", ".csv"), row.names = F)
```
