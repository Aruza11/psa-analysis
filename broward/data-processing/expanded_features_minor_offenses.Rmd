...
new <- outcomes %>% 
  na.exclude()
new %>% select(recid, recidnot, years)
overall_amt = sum(new$recid, na.rm = TRUE)
outcomes$recid[1:10]
nrow(new)
...
save(data_before, data_on, data_after, data_before_on,
     ...
     file = "C:/Users/binha/Documents/Duke/Cynthia Research/KY-analysis-mytrials/broward/data/expanded_features_minor_offenses.Rdata")

write.csv(outcomes, file = "C:/Users/binha/Documents/Duke/Cynthia Research/KY-analysis-mytrials/broward/data/labels_minor_offenses.csv", row.names = FALSE)
```
