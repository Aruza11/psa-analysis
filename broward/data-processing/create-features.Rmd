...
train = merge(x=train, y=labels, by=c('person_id', 'screening_date'))%>% 
    ...
    mutate(recid_two_year = as.factor(recid_two_year),
           recid_drug2 = as.factor(recid_drug2),
           recid_property2 = as.factor(recid_property2),
           recid_F2 = as.factor(recid_F2),
           recid_M2 = as.factor(recid_M2),
           recid_violent2 = as.factor(recid_violent2),
           recid_six_month = as.factor(recid_six_month),
           recid_drug6 = as.factor(recid_drug6),
           recid_property6 = as.factor(recid_property6),
           recid_F6 = as.factor(recid_F6),
           recid_M6 = as.factor(recid_M6),
           recid_violent6 = as.factor(recid_violent6))
