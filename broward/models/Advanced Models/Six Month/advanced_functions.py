...
def EBM(train_x, train_y, test_x, test_y, learning_rate, depth, estimators, holdout_split, seed):
    ...
    ### extract race & gender
    train_gender = train_x['sex'].values
    train_race = train_x['race'].values
    test_gender = test_x['sex'].values
    ...
    gam = ExplainableBoostingClassifier(random_state=seed, 
                                        ...
                                        holdout_split = best_param['holdout_split']).fit(train_x, train_y)  
