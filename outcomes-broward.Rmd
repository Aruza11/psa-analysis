...
scores_quantiles =as.dataframe() quantile(scores_outcomes$arnold_nvca, probs = seq(0,1,.1),na.rm = T, names = F)

quantile(scores_outcomes$`Risk of Violence_decile_score`, probs = seq(0,1,.1),na.rm = T, names = F)
