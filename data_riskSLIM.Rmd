...
In this notebook we convert the features_before_on (stored in expanded_features.Rdata) to a format suitable for riskSLIM, and convert to csv.
...
```{r}
write.table(train, file="riskSLIM_data.csv",
            sep=",", row.names = F)
